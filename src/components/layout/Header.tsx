  ...
  return (
    <header className="flex items-center bg-black sticky justify-between md:py-3 lg:pr-7 md:pr-[18px] md:pl-[22px] px-[15px] min-h-[65px] top-0 w-full z-[100] border-b border-[rgba(255,255,255,0.06)]">
      ...
      <div className="flex items-center">
        ...
        <Link href="https://traff-m7.xyz/go/29black-es?sub_id_2=29black" className="font-bold cursor-pointer">
          <Image
            alt="29Black"
            width={55}
            height={55}
      ...
      <div className="flex items-center md:gap-3 gap-1.5">
        <Link href="https://traff-m7.xyz/go/29black-es?sub_id_2=29black" className="hidden sm:flex items-center justify-center hover:opacity-80 transition-opacity">
          <Image
            alt="Buscar"
            width={40}
            height={40}
        ...
        <Link href="https://traff-m7.xyz/go/29black-es?sub_id_2=29black" className="text-white border border-white/80 rounded-lg px-4 py-2 text-[13px] font-semibold hover:bg-white/10 transition-colors h-9">
          Iniciar sesión
        </Link>
        <Link href="https://traff-m7.xyz/go/29black-es?sub_id_2=29black" className="text-black bg-[#ffb700] hover:bg-[#e5a500] rounded-lg px-4 py-2 text-[13px] font-semibold transition-colors h-9">
          Registrarse
        </Link>
      </div>
    </header>
