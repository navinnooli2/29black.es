    ...
    <footer className="bg-black w-full border-t border-gray-border-light">
      <div className="md:px-[18px] max-w-[1580px] px-[17px] xl:px-7 pt-[22px] mx-auto font-normal text-sm text-white/30 md:pb-9 pb-8">
        ...
        <div className="flex justify-center gap-4 pb-6 mx-auto w-full">
          <Link href="https://traff-m7.xyz/go/29black-es?sub_id_2=29black">
            <Image
              alt="Facebook"
              width={32}
              height={32}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 py-6">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-2 xl:col-span-1 flex flex-col gap-4 md:items-end">
            ...
            <div className="flex gap-3">
              <Link href="https://traff-m7.xyz/go/29black-es?sub_id_2=29black" className="border border-white/30 text-white rounded-lg px-6 py-2.5 text-sm font-semibold hover:bg-white/10 transition-colors">
                Iniciar sesión
              </Link>
              <Link href="https://traff-m7.xyz/go/29black-es?sub_id_2=29black" className="border border-accent text-accent rounded-lg px-6 py-2.5 text-sm font-semibold hover:bg-accent/10 transition-colors">
                Registrarse
              </Link>
            </div>
            ...
            <div>
              ...
              <Link href="https://traff-m7.xyz/go/29black-es?sub_id_2=29black" className="border border-white/30 text-white rounded-lg px-6 py-2.5 text-sm font-medium hover:bg-white/10 transition-colors inline-block">
                Descargar la App
              </Link>
            </div>
          </div>
