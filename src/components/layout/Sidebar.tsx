    ...
    >
      ...
      {isOpen && (
        <div className="px-3 pb-6 pt-2">
          <Link href="/play" className="flex items-center gap-2 w-full bg-[#ffb700] hover:bg-[#e5a500] text-black font-semibold rounded-lg px-4 py-3 text-[14px] transition-colors">
