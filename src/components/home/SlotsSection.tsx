...
export default function SlotsSection() {
  return (
    <section className="py-5">
      <SectionHeader icon="🎰" title="Tragamonedas" seeAllHref="https://traff-m7.xyz/go/29black-es?sub_id_2=29black" />
        ...
        {slotGames.map((game, i) => (
          ...
          >
            <div className="relative rounded-xl overflow-hidden bg-[#1a1a1a] aspect-[3/4] mb-2">
              ...
              <a href="https://traff-m7.xyz/go/29black-es?sub_id_2=29black" className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center z-10">
